#!/usr/bin/env python3
"""
Generate ALL Reference Audio Files for voices_3 experiment
...
# Voice configurations with REVISED voice IDs from user
VOICES = {
...
def main():
    """Generate all reference audio files with HD1 QUALITY for voices_3"""
    print("🎵 HD1-QUALITY Reference Audio Generation for voices_3")
    print("📋 REVISED PLAN: Only expressivity_0.6, New Voice IDs")
    print("=" * 60)
    
    # Only generate expressivity_0.6 (no expressivity_none needed)
    expressivity = 'expressivity_0.6'
    print(f"\n📁 Generating {expressivity} references...")
    
    output_dir = f"public/voices_3/{expressivity}/"
    ...
    print(f"🎯 Expected: 2 voices × 12 emotions × 3 text_types = 72 reference files")
    ...
    # Final verification
    total_files = len(os.listdir(f"public/voices_3/{expressivity}/"))
    print(f"\n🎯 TOTAL REFERENCE FILES GENERATED: {total_files}")
    print(f"🎵 Expected: 72 reference files")
    print("✅ HD1-QUALITY Reference Generation Complete!")
