...
TOKEN = "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IjU3YmZiMmExMWRkZmZjMGFkMmU2ODE0YzY4NzYzYjhjNjg3NTgxZDgiLCJ0eXAiOiJKV1QifQ..e0s4o6VDxd2MxEA8ZPzglKb7TGV7J6wzvvRWvT1sb-ttrwQpneGid5Pt0B0jyQ2bm9j1O8tajkDKCZITwF0Usf5kcp02f5Qdbume-ISfx7HWLxs15qmXEl3xapwtGDU-_SRzAg-9i5ueMKy1TrqfMALi-Ut6zUNvYeZtHBULQ9slTkzKym47AxGWVoCdfSoqgI6yGBRhNgNgCBKKCj4A1CrUk2wGUl5A2Akd3qv5LvSL0S4Zv7vwFClqpJ3G1yRr0DRbMLFRovwu87V83KuDllWgU3QsMVSFQT4pdjWWS3FUiLBbSLO6wSzgiLDQ1gFguw_Tg4zERrllq-6EFFingQ"
    ...
    try:
        ...
        for _ in range(30):
            ...
            if result["status"] == "done":
                ...
                output_path = Path(f"public/voices_2/{folder}/{output_filename}")
        ...
        for voice_name in ACTORS.keys():
            for text_type, text in emotion_data["texts"].items():
                for scale in EMOTION_SCALES:
                    ...
                    folder = f"expressivity_{expressivity}" if expressivity != "none" else "expressivity_none"
                    output_path = Path(f"public/voices_2/{folder}/{filename}")
