#!/usr/bin/env python3
"""
Complete ONLY expressivity_0.6 sample generation
Skip files that already exist to avoid regeneration
"""
...
# Fresh API token
API_TOKEN = "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6ImVmMjQ4ZjQyZjc0YWUwZjk0OTIwYWY5YTlhMDEzMTdlZjJkMzVmZTEiLCJ0eXAiOiJKV1QifQ..AQO3XVBMoAyBa9iSTHGlI8B0mVaa8Yvb52CUysclVMdMahq9GrCkQ5AxRZafIhrQSyUOudtKEAHBwW2mjiuVYSC2CXAagdPmplZnRw1mouDfuHjJSF1U9rsfJcCl3PbkMnStc0J_34zyBSveZccKWHxsricVwT0K0hoRyq7QaCrud_kzbY-1k3dXx9PSDQyI_-Auj2iFaIImviLb_KbKngGxLUzgT67Vd3ANrMUJDNJtO2Ng6csu-UIAoLXI15rLx2aOw1883N2iEZBeCe-Gy_H6Q_L2LuqMMh2MtCBga75zOSz4nDBBffbEWjeE2wn8pT4ysajusAaWHREWZjqLVw"
...
def main():
    """Complete ONLY missing expressivity_0.6 files"""
    print("🎵 Completing expressivity_0.6 with HD1 quality")
    print("=" * 60)
    ...
    # Generate emotion_label samples (if missing)
        ...
        for emotion in EMOTION_LABELS:
            for text_type in TEXT_TYPES:
                for scale in SCALES:
                    ...
                    text = f"{text_base}|0.6"  # expressivity_0.6 suffix
    ...
    # Generate emotion_vector samples (if missing)
    for voice_name, voice_id in VOICES.items():
    ...
    print(f"📊 Files to generate: {len(all_requests)}")
    ...
    # Final verification
    total_files = len(os.listdir("public/voices_2/expressivity_0.6/"))
    print(f"\n🎯 expressivity_0.6 now has: {total_files} files")
    print(f"🎵 Expected: 504 files (72 references + 432 samples)")
    
    if total_files >= 504:
        print("✅ expressivity_0.6 COMPLETE!")
    else:
        print(f"⚠️  Still need {504 - total_files} more files")
